<script src="assets/static/js/initTheme.js"></script>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item <?= ($uri == '' || $uri == 'admin') ? 'active' : '' ?>">
             ...
             <li class="sidebar-item <?= ($uri == 'mobil') ? 'active' : '' ?>">

                <a href="<?= base_url('mobil') ?>" class='sidebar-link'>
                    <i class="bi bi-car-front-fill"></i>
                    <span>Data Mobil</span>
                </a>
            </li>

            <li class="sidebar-item <?= ($uri == 'pelanggan') ? 'active' : '' ?>">
